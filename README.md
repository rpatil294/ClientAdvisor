...
- **Client** -- simulated client with a fixed profile. Responds in character, reveals information, pushes back on unsuitable advice.
- **Analyst** -- research agent with tool access (vector search + web search). Receives structured research briefs, returns findings. 
